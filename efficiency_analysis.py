...
print(timeit.repeat("e.load_dataset('data/search_dataset.csv')", setup=setup, number=number, repeat=repeat))


print("Time to process query file without printing output: ")
print(timeit.repeat("e.process_query_file('queries/queries.txt', False, *data_set)", setup=setup_with_loaded_dataset, number=number, repeat=repeat))
